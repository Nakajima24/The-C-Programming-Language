...
//
//v2. duplicate the element, including the result after calculate, from original array and save it to new array . lastly. pop the element in original array which has taken
